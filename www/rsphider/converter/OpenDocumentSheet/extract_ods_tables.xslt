...
<!--
    Originals:
    a)  extract_tables.xslt - Extract tables from OpenDocument spreadsheet
        Copyright (C) 2006  J. David Eisenberg
        
    b)  extract_tables_simplexml.xslt - Extract tables from OpenDocument spreadsheet
        Copyright (C) 2006  Shih Yuncheng <shirock@educities.edu.tw>
    
    Sphider-plus implementation:
        extract_ods_tables.xslt - Still extracting spreadsheet tables
        Copyright (C) 2010  Rolf Kellner [Tec]   
