 ...
 * @license   http://www.gnu.org/licenses/lgpl.html LGPL
 * @link      http://php-ids.org/
 * @version   modified by Rolf Kellner [Tec] 2010-11-24
...
class IDS_Filter
{
    ...
    {
        $accept = array('..\converter');		// ('..\converter', 'other_strings_to_be accepted', ‘not_yet_defined’)
        ...
        return (bool) preg_match(
            '/' . $this->getRule() . '/ms', strtolower(str_replace($accept, "",$string))
        );
    }
