<?php
    ...
    /** JFIELD replaced the default stemmer with this one from:
          http://tartarus.org/~martin/PorterStemmer/
        it correctly stems "informal" to "inform", for instance,
        which the built-in sphider stemmer did not. I also
        changed the name of the class and function so that it
        was a drop-in replacement. We should switch to snoball
        probably, and fix all the other languages to use those **/
